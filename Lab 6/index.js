...
function whoWon() {
  ...
  document.querySelector("h2").innerHTML = "Balance: $" + balance;
  
}

//Make a function that calculates the number of rolls and adds it to the balance using the input from howManyTimesPlay

function letsPlay(){
  let numRolls = parseInt(prompt("How many times would you like to roll the dice?"));
